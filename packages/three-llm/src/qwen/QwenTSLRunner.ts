...
import { TSLConcat } from '../tsl/TSLConcat.js';
  ...
  constructor(weights: QwenWeights, options: RunnerOptions = {}) {
    ...
    for (const layer of this.layers) {
      this.computeNodes.push(
        ...orderedComputeNodes(layer.ln1, layer.mixer, layer.addAttention, layer.ln2, layer.mlp, layer.addMLP),
      );
    }
